...
**Implemented: 199 / 245 valid opcodes (81%)**
...
| `0x80–0x87` | `ADD A,r` | Entire ADD family missing — next up, blocking `09-op r,r.gb` |
...
- `09-op r,r.gb` — **In progress** — blocked on `0x80 ADD A,B` (whole ADD A,r family missing).
